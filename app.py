...
def init_sample_data():
    ...
    if User.query.first() is None:
        ...
        courses_data = [
            ('IF301', 'Praktikum Sistem Multimedia', 3, 3),
            ('IF302', 'Praktikum Pengantar Pemograman Game', 3, 3),
            ('IF501', 'Praktikum Pembelajaran Mesin', 5, 3),
            ('IF502', 'Praktikum Pemograman Visual', 5, 3),
            ('IF503', 'Praktikum Sistem Operasi dan Jaringan Komputer', 5, 3),
            ('IF701', 'Praktikum IoT', 7, 3),
            ('IF504', 'Praktikum Pemodelan dan Simulasi', 5, 3),
            ('IF101', 'Praktikum Statistik & Probabilitas', 1, 3),
            ('IF303', 'Praktikum GitHub', 3, 2),
            ('IF304', 'Praktikum Sistem Basis Data', 3, 3),
            ('IF305', 'Praktikum Aplikasi Dasar Komputer', 3, 3),
            ('IF702', 'Praktikum Sistem Informasi Geografis', 7, 3),
            ('IF306', 'Praktikum Analisis dan Perancangan SI', 3, 3),
            ('IF102', 'Praktikum Algoritma dan Pemrograman 1', 1, 3),
            ('IF103', 'Praktikum Data Analisis Dasar', 1, 3),
            ('IF505', 'Praktikum Pengelolaan Proyek SI', 5, 3),
            ('IF104', 'Praktikum Akuntansi', 1, 3),
            ('IF307', 'Praktikum Bahasa Pemograman Tingkat Rendah', 3, 3),
        ]
